            ...
            public void onClick(View v) {
                ...
                call.enqueue(new Callback<Member>() {
                    ...
                    public void onFailure(Call<Member> call, Throwable t) {
                        System.out.println("전송된 JSON3 응답에 실패함: " + jsonObject.toString() + "\n오류 메시지: " +t.getMessage()); // 터미널에 출력
                        Toast.makeText(ServerRegister.this, "회원가입 실패 - 인터넷 연결이나 서버 상태를 확인하세요. " , Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
